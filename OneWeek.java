...
public class OneWeek extends Date
{
	...
	private int[] days_of_week;		// Indicates which number day of the week it is (e.g. 1st day of the week)
	...
	public void createWeek()
	{
		...
		while(count != 7)
		{
			switch(c1.get(Calendar.MONTH)) // They start at 0
			{
			case 0:
